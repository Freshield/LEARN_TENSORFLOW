...
#train the model
#ver 1.0
def transfer_train_dataset_begin(para_dic, model_name, model_path=None):
            ...
            while epoch < epochs:
                ...
                while loop < loops:
                    ...
                    if loop % loop_eval_num == 0 or loop == loops:
                        ...
                        temp_para = [SPAN, dir, epochs, data_size, file_size, loop_eval_num, batch_size,
                                     train_file_size, valid_file_size, test_file_size, reg, lr_rate, lr_decay,
                                     keep_prob_v, log_dir, module_dir, eval_last_num, epoch, loop, best_model_number,
                                     best_model_acc_dic, best_model_dir_dic]

                        answer = fm.interrupt_flow(temp_para, sess, log, loop_indexs)
                        if answer == 'Done':
                            return 'Done'

                        [SPAN, dir, epochs, data_size, file_size, loop_eval_num, batch_size, train_file_size,
                         valid_file_size, test_file_size, reg, lr_rate, lr_decay, keep_prob_v, log_dir, module_dir,
                         eval_last_num, epoch, loop, best_model_number, best_model_acc_dic,
                         best_model_dir_dic] = temp_para
