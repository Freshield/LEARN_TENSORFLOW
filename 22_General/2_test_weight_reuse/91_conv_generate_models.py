...
for model in range(10):
    ...
    wb = Weight_Bag()
    wb.save_tensor(sess, W_conv1, 'W_conv1')
    wb.save_tensor(sess, b_conv1, 'b_conv1')
    wb.save_tensor(sess, W_conv2, 'W_conv2')
    wb.save_tensor(sess, b_conv2, 'b_conv2')
    wb.save_tensor(sess, W_fc1, 'W_fc1')
    wb.save_tensor(sess, b_fc1, 'b_fc1')
    wb.save_tensor(sess, W_fc2, 'W_fc2')
    wb.save_tensor(sess, b_fc2, 'b_fc2')

    wb.save_dic_to_hdf5('weights/mnist_conv_wb_%d.hdf5' % model)
    '''
    wb.hdf5_to_restore_dic('weights/mnist_conv_wb_%d.hdf5' % i)
