                ...
                with tf.Session() as sess:
                    ...
                    for epoch in xrange(epochs):
                        ...
                        for loop in xrange(loops):
                            ...
                            loop_loss_v, loop_acc = do_train_file(sess, train_pl, dir, train_file, SPAN, max_step,
                                                                  batch_size, keep_prob_v)
                            ...
                            if (loop != 0 and loop % last_loop_num == 0) or loop == loops - 1:
                                # show the time
                                time_show(before_time, last_loop_num, loop, loops, epoch, epochs, log, count, count_total)
                                ...
                                for step in xrange(steps):
                                    ...
                                    step_train_acc = do_eval(sess, X_train, para_train, y_train, batch_size,
                                                             correct_num, placeholders)
                                    train_acc += step_train_acc

                                    step_valid_acc = do_eval(sess, X_valid, para_valid, y_valid, batch_size,
                                                             correct_num, placeholders)
