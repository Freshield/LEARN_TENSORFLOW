...
def inference(input_layer, train_phase, keep_prob):
    parameters = []
    #input shape should be (N,96,96,93)
    input_depth = input_layer.shape[-1]

    #input[N,96,96,93],output[N,96,96,128]
    ...
    #input[N,96,96,128],output[N,48,48,128]
    ...
    avg_pool_layer = tf.nn.avg_pool(resnet_l4, [1,6,6,1], [1,1,1,1], 'VALID')
