...
array_file = '/home/freshield/Ciena_data/dataset_10k/min_max_10k.csv'
...
while loop:
    try:
        ...
        np.savetxt("/home/freshield/Ciena_data/dataset_10k/train_set_norm.csv", train_set, delimiter=",")
        np.savetxt("/home/freshield/Ciena_data/dataset_10k/validation_set_norm.csv", validation_set, delimiter=",")
        np.savetxt("/home/freshield/Ciena_data/dataset_10k/test_set_norm.csv", test_set, delimiter=",")
